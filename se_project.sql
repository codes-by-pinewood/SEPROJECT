CREATE DATABASE  IF NOT EXISTS `se_project` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `se_project`;
...
CREATE TABLE `Game` (
  ...
  `distributor_present` tinyint DEFAULT NULL,
...
-- Dump completed on 2021-03-09 10:16:58
